...
int main() {
  ...
  W1 = Eigen::MatrixXd::Random(2, 4);
  W2 = Eigen::MatrixXd::Random(4, 1);
  B1 = Eigen::MatrixXd::Random(1, 4);
  ...
  for(size_t i = 0; i < 10000; i++) {
    for (size_t d = 0; d < 4; d++) {
      ...
      Eigen::MatrixXd delCostdelW1 = inputDataSet.at(d).transpose() * ((delCostdelZ2 * W2.transpose()).array() * G_1.array() * (1 - G_1.array())).matrix();
